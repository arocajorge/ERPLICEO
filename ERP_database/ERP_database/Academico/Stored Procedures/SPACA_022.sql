...
FROM     dbo.tb_persona AS pa INNER JOIN
                  ...
                  dbo.aca_MatriculaAsistencia AS ma INNER JOIN
                  ...
                  dbo.tb_persona AS tb_persona_1 ON a.IdPersona = tb_persona_1.IdPersona ON cp.IdEmpresa = m.IdEmpresa AND cp.IdAnio = m.IdAnio AND cp.IdSede = m.IdSede AND cp.IdNivel = m.IdNivel AND cp.IdJornada = m.IdJornada AND 
