create view academico.VWFAC_003_aplicaciones AS
SELECT fa_notaCreDeb_x_fa_factura_NotaDeb.IdEmpresa_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdSucursal_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdBodega_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdNota_nt, 
                  ...
                  fa_notaCreDeb.CodDocumentoTipo + '-' + fa_notaCreDeb.Serie1 + '-' + fa_notaCreDeb.Serie2 + '-' + fa_notaCreDeb.NumNota_impresa) AS NumFactura, IIF(fa_notaCreDeb_x_fa_factura_NotaDeb.vt_tipoDoc = 'FACT', fa_factura.vt_fecha, 
                  fa_notaCreDeb.no_fecha) vt_fecha
