...
select IdEmpresa,Tipo,IdCbteVta,Orden,vt_fecha,vt_Observacion,Referencia,Anio,IdMes,smes,isnull(@SaldoInicial,0) SaldoInicial, Debe,Haber,Valor, ISNULL(@SaldoInicial,0) + sum(Valor) over(order by vt_fecha, Orden, IdCbteVta) Saldo,
