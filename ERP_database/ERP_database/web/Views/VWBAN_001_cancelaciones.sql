...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWBAN_001_cancelaciones';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'idth = 1200
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWBAN_001_cancelaciones';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[43] 4[3] 2[3] 3) )"
      End
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 9
         Width = 284
         W', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWBAN_001_cancelaciones';
