...
{
    public partial class BAN_015_liceo_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public BAN_015_liceo_Rpt()
        {
            InitializeComponent();
        }

        private void BAN_015_liceo_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            List<BAN_015_Info> lst_rpt = bus_rpt.GetList(usuario,"LICEO", fechaIni, fechaFin, mostrarSaldo0);
            
            Lista = lst_rpt.Where(q => q.Tipo == "BANCOS").ToList();
            lst_rpt = lst_rpt.Where(q => q.Tipo == "FLUJOS").ToList();
                        
            tb_empresa_Bus bus_empresa = new tb_empresa_Bus();
            var emp = bus_empresa.get_info(1);
