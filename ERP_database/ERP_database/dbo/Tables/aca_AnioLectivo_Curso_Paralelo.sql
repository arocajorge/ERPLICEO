CREATE TABLE [dbo].[aca_AnioLectivo_Curso_Paralelo] (
    ...
    [IdProfesorTutor]     NUMERIC (18)  NULL,
    [IdProfesorInspector] NUMERIC (18)  NULL,
    ...
    CONSTRAINT [FK_aca_AnioLectivo_Curso_Paralelo_aca_Profesor] FOREIGN KEY ([IdEmpresa], [IdProfesorTutor]) REFERENCES [dbo].[aca_Profesor] ([IdEmpresa], [IdProfesor]),
    CONSTRAINT [FK_aca_AnioLectivo_Curso_Paralelo_aca_Profesor1] FOREIGN KEY ([IdEmpresa], [IdProfesorInspector]) REFERENCES [dbo].[aca_Profesor] ([IdEmpresa], [IdProfesor]),
