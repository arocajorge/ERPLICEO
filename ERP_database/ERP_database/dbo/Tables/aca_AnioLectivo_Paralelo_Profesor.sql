CREATE TABLE [dbo].[aca_AnioLectivo_Paralelo_Profesor] (
    ...
    CONSTRAINT [PK_aca_AnioLectivo_Paralelo_Profesor_1] PRIMARY KEY CLUSTERED ([IdEmpresa] ASC, [IdAnio] ASC, [IdSede] ASC, [IdNivel] ASC, [IdJornada] ASC, [IdCurso] ASC, [IdMateria] ASC, [IdParalelo] ASC, [IdProfesor] ASC),
