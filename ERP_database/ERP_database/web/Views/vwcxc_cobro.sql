...
AS
SELECT     dbo.cxc_cobro.IdEmpresa, dbo.cxc_cobro.IdSucursal, dbo.cxc_cobro.IdCobro, dbo.cxc_cobro.IdCliente, dbo.tb_persona.pe_nombreCompleto, 
                      dbo.cxc_cobro.IdCobro_tipo, dbo.cxc_cobro.cr_fecha, dbo.cxc_cobro.cr_TotalCobro, dbo.cxc_cobro.cr_estado, dbo.tb_sucursal.Su_Descripcion, 
                      dbo.cxc_cobro.cr_observacion, ISNULL(ISNULL(cxc_cobro.CR_TARJETA, dbo.cxc_cobro.cr_NumDocumento), ba.ba_descripcion) AS cr_NumDocumento, ISNULL(Tipo.nom_Motivo_tipo_cobro, 
                      t2.nom_Motivo_tipo_cobro) AS nom_Motivo_tipo_cobro, dbo.cxc_cobro.IdAlumno, tb_persona_1.pe_nombreCompleto AS NomAlumno, dbo.cxc_cobro.cr_Saldo, 
                      dbo.cxc_cobro.IdUsuario
FROM         dbo.tb_persona AS tb_persona_1 INNER JOIN
                      ...
                      dbo.tb_sucursal ON dbo.cxc_cobro.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.cxc_cobro.IdSucursal = dbo.tb_sucursal.IdSucursal ON 
                      dbo.aca_Alumno.IdEmpresa = dbo.cxc_cobro.IdEmpresa AND dbo.aca_Alumno.IdAlumno = dbo.cxc_cobro.IdAlumno LEFT OUTER JOIN
                      ...
                      AS Tipo ON Tipo.IdEmpresa = dbo.cxc_cobro.IdEmpresa AND Tipo.IdSucursal = dbo.cxc_cobro.IdSucursal AND Tipo.IdCobro = dbo.cxc_cobro.IdCobro LEFT OUTER JOIN
