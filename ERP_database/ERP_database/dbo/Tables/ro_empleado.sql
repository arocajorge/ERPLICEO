CREATE TABLE [dbo].[ro_empleado] (
    ...
    [CodCatalogoSexo]                      VARCHAR (25)   NULL,
    [CodCatalogoEstadoCivil]               VARCHAR (25)   NULL,
    ...
    CONSTRAINT [FK_ro_empleado_tb_Catalogo] FOREIGN KEY ([CodCatalogoSexo]) REFERENCES [dbo].[tb_Catalogo] ([CodCatalogo]),
    CONSTRAINT [FK_ro_empleado_tb_Catalogo1] FOREIGN KEY ([CodCatalogoEstadoCivil]) REFERENCES [dbo].[tb_Catalogo] ([CodCatalogo])
);
