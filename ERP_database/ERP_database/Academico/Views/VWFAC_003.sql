...
SELECT fa_notaCreDeb_det.IdEmpresa, fa_notaCreDeb_det.IdSucursal, fa_notaCreDeb_det.IdBodega, fa_notaCreDeb_det.IdNota, fa_notaCreDeb_det.Secuencia, fa_notaCreDeb_det.IdProducto, in_Producto.pr_descripcion, 
                  ...
                  AS sc_subtotalIVA, iif(fa_notaCreDeb_det.vt_por_iva = 0, fa_notaCreDeb_det.sc_subtotal, 0) AS sc_subtotal0, fa_notaCreDeb_det.sc_iva, fa_notaCreDeb_det.vt_por_iva, tb_persona.pe_nombreCompleto Nombres, 
                  aca_Alumno.Codigo AS CodigoAlumno, Su_Descripcion, fa_notaCreDeb.Serie1 + '-' + fa_notaCreDeb.Serie2 + '-' + fa_notaCreDeb.NumNota_Impresa AS NumNota_Impresa, fa_notaCreDeb.no_fecha, fa_notaCreDeb.no_fecha_venc, 
                  fa_notaCreDeb.CreDeb, fa_notaCreDeb.sc_observacion, fa_notaCreDeb_det.sc_total, tipo.No_Descripcion, e.NomSede, e.NomNivel, e.NomJornada, e.NomCurso, e.NomParalelo, e.CodigoParalelo, e.NomPlantilla, 
                  fa_notaCreDeb.IdUsuario, fa_notaCreDeb.Fecha_UltMod, fa_notaCreDeb.FechaTransaccion
