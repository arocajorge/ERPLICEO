...
FROM     dbo.fa_TipoNota RIGHT OUTER JOIN
                  ...
                  dbo.fa_TipoNota.IdEmpresa = dbo.fa_notaCreDeb.IdEmpresa AND dbo.fa_TipoNota.IdTipoNota = dbo.fa_notaCreDeb.IdTipoNota LEFT OUTER JOIN
                  dbo.tb_persona INNER JOIN
                  dbo.aca_Alumno ON dbo.tb_persona.IdPersona = dbo.aca_Alumno.IdPersona ON dbo.fa_notaCreDeb.IdEmpresa = dbo.aca_Alumno.IdEmpresa AND dbo.fa_notaCreDeb.IdAlumno = dbo.aca_Alumno.IdAlumno LEFT OUTER JOIN
