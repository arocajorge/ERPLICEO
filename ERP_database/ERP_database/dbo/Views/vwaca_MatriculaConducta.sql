...
SELECT dbo.aca_MatriculaConducta.IdEmpresa, dbo.aca_MatriculaConducta.IdMatricula, dbo.aca_Matricula.IdAlumno, dbo.aca_Matricula.IdAnio, dbo.aca_Matricula.IdSede, dbo.aca_Matricula.IdNivel, dbo.aca_Matricula.IdJornada, 
                  dbo.aca_Matricula.IdCurso, dbo.aca_Matricula.IdParalelo, dbo.tb_persona.pe_nombreCompleto, dbo.aca_MatriculaConducta.PromedioP1, dbo.aca_MatriculaConducta.PromedioFinalP1, dbo.aca_MatriculaConducta.PromedioP2, 
                  dbo.aca_MatriculaConducta.PromedioFinalP2, dbo.aca_MatriculaConducta.PromedioP3, dbo.aca_MatriculaConducta.PromedioFinalP3, dbo.aca_MatriculaConducta.PromedioQ1, dbo.aca_MatriculaConducta.PromedioFinalQ1, 
                  dbo.aca_MatriculaConducta.PromedioP4, dbo.aca_MatriculaConducta.PromedioFinalP4, dbo.aca_MatriculaConducta.PromedioP5, dbo.aca_MatriculaConducta.PromedioFinalP5, dbo.aca_MatriculaConducta.PromedioP6, 
                  dbo.aca_MatriculaConducta.PromedioFinalP6, dbo.aca_MatriculaConducta.PromedioQ2, dbo.aca_MatriculaConducta.PromedioFinalQ2, dbo.aca_MatriculaConducta.PromedioGeneral, dbo.aca_MatriculaConducta.PromedioFinal, 
                  dbo.vwaca_AnioLectivo_Curso_Paralelo.Descripcion, dbo.vwaca_AnioLectivo_Curso_Paralelo.NomSede, dbo.vwaca_AnioLectivo_Curso_Paralelo.NomNivel, dbo.vwaca_AnioLectivo_Curso_Paralelo.NomJornada, 
                  dbo.vwaca_AnioLectivo_Curso_Paralelo.NomCurso, dbo.vwaca_AnioLectivo_Curso_Paralelo.NomParalelo, dbo.vwaca_AnioLectivo_Curso_Paralelo.OrdenParalelo, dbo.vwaca_AnioLectivo_Curso_Paralelo.OrdenCurso, 
                  dbo.vwaca_AnioLectivo_Curso_Paralelo.OrdenJornada, dbo.vwaca_AnioLectivo_Curso_Paralelo.OrdenNivel
