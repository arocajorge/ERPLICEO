CREATE VIEW Academico.VWBAN_002
AS
...
FROM     dbo.ba_Cbte_Ban_tipo WITH (nolock) INNER JOIN
                  ...
                  dbo.ba_tipo_nota WITH (nolock) ON dbo.ba_Cbte_Ban.IdEmpresa = dbo.ba_tipo_nota.IdEmpresa AND dbo.ba_Cbte_Ban.IdTipoNota = dbo.ba_tipo_nota.IdTipoNota
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'Academico', @level1type = N'VIEW', @level1name = N'VWBAN_002';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'    Right = 320
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'Academico', @level1type = N'VIEW', @level1name = N'VWBAN_002';
