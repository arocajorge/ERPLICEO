--exe [dbo].[spaca_corregir_menu] 1,1,'ADMIN'
...
where me.IdEmpresa = @IdEmpresa 
and me.IdUsuario = @IdUsuario
and ISNULL(menu.IdMenuPadre,0) != 0
and not exists(
select * from aca_Menu_x_seg_usuario as f
where f.IdEmpresa = @IdEmpresa 
and f.IdMenu = menu.IdMenuPadre
...
--SELECT * FROM aca_Menu_x_seg_usuario WHERE IdMenu IN (58,98) AND IdEmpresa= 1 AND IdUsuario = 'admin'