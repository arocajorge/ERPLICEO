...
namespace Core.Erp.Web.Reportes.RRHH
{
    public partial class ROL_019_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ROL_019_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            int IdTipoNomina = string.IsNullOrEmpty(p_IdTipoNomina.Value.ToString()) ? 0 : Convert.ToInt32(p_IdTipoNomina.Value);
            ...
            List<ROL_019_Info> lst_rpt = bus_rpt.get_list(IdEmpresa, IdSucursal, IdNomina, IdTipoNomina, fecha_ini, fecha_fin);
