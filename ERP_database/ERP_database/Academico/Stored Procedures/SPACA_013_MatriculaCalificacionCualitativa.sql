...
FROM     dbo.aca_MatriculaCalificacionCualitativa AS mcc INNER JOIN
                  ...
                  dbo.aca_Profesor AS pro ON pro.IdEmpresa = mcc.IdEmpresa AND pro.IdProfesor = mcc.IdProfesor LEFT OUTER JOIN
                  dbo.tb_persona AS pp ON pro.IdPersona = pp.IdPersona INNER JOIN
