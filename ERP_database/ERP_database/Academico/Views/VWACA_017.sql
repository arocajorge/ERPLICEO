CREATE VIEW Academico.VWACA_017
AS
...
WHERE  (al.Estado = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'Academico', @level1type = N'VIEW', @level1name = N'VWACA_017';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'Academico', @level1type = N'VIEW', @level1name = N'VWACA_017';
