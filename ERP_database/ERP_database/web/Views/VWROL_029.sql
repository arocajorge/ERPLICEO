...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWROL_029';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'1350
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWROL_029';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "ro_AjusteImpuestoRenta"
            Begin Extent = 
               Top = 7
               Left = 48
               Bottom = 170
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Filter = 1350
         Or = 1350
         Or = ', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWROL_029';
