...
SELECT dbo.ro_empleado.IdEmpresa, dbo.ro_empleado.IdSucursal, dbo.ro_empleado.IdDivision, dbo.ro_empleado.IdArea, dbo.ro_empleado.IdEmpleado, dbo.ro_contrato.IdNomina IdTipoNomina, su.Su_Descripcion, 
                  ...
                  + ' mes(es)' AS antiguedad_string, ro_empleado.CodCatalogo_Ubicacion, CA.ca_descripcion UbicacionGeneral, nt.Descripcion TipoNomina, dbo.tb_persona.pe_correo, dbo.tb_persona.pe_telfono_Contacto, 
                  dbo.tb_persona.pe_direccion, cat1.ca_descripcion sexo
FROM     dbo.ro_catalogo INNER JOIN
                  ...
                  tb_Catalogo cat ON cat.CodCatalogo = dbo.tb_persona.IdEstadoCivil 
				  LEFT JOIN
