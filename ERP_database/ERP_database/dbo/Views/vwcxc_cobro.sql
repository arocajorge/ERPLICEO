...
SELECT FC.IdPersona, C.IdEmpresa, C.IdSucursal, C.IdCobro, C.IdCobro_tipo, C.IdCliente, C.cr_TotalCobro, C.cr_fecha, C.cr_fechaCobro, C.cr_fechaDocu, C.cr_observacion, C.cr_Banco, C.cr_cuenta, C.cr_Tarjeta, C.cr_NumDocumento, 
                  C.cr_estado, C.cr_recibo, C.Fecha_Transac, C.IdUsuario, C.IdUsuarioUltMod, C.Fecha_UltMod, C.IdUsuarioUltAnu, C.Fecha_UltAnu, C.nom_pc, C.ip, S.Su_Descripcion AS nSucursal, P.pe_nombreCompleto AS nCliente, '' AS cr_NumCheque, 
                  1 AS IdVendedorCliente, C.cr_Codigo, C.IdTipoNotaCredito, C.cr_propietarioCta, C.IdBanco, C.IdCaja, C.cr_es_anticipo, C.IdAlumno
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[52] 4[10] 2[7] 3) )"
      End
