...
FROM     dbo.fa_factura AS a INNER JOIN
                  ...
                  dbo.tb_persona AS e ON d.IdPersona = e.IdPersona LEFT OUTER JOIN
                  dbo.ro_empleado AS f ON a.IdEmpresa_rol = f.IdEmpresa AND a.IdEmpleado = f.IdEmpleado LEFT OUTER JOIN
