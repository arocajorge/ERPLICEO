...
AS
SELECT dbo.Af_Activo_fijo.IdEmpresa, dbo.Af_Activo_fijo.IdActivoFijo, dbo.Af_Activo_fijo.Af_fecha_compra, dbo.Af_Activo_fijo.Af_costo_compra, dbo.Af_Activo_fijo.Estado, dbo.Af_Activo_fijo.Af_observacion, 
                  dbo.Af_Activo_fijo.Af_Nombre, dbo.tb_sucursal.Su_Descripcion, dbo.Af_Activo_fijo_tipo.Af_Descripcion AS NomTipo, dbo.Af_Activo_fijo_Categoria.Descripcion AS NomCategoria, 
                  dbo.Af_Departamento.Descripcion AS NomDepartamento, dbo.tb_persona.pe_nombreCompleto AS NomEncargado, tb_persona_1.pe_nombreCompleto AS NomCustodio, dbo.Af_Activo_fijo.Cantidad, 
                  dbo.Af_Activo_fijo.FechaEntrega
FROM     dbo.Af_Activo_fijo INNER JOIN
                  ...
                  dbo.tb_persona AS tb_persona_1 ON dbo.Af_Activo_fijo.IdEmpleadoCustodio = tb_persona_1.IdPersona INNER JOIN
                  dbo.tb_persona ON dbo.Af_Activo_fijo.IdEmpleadoEncargado = dbo.tb_persona.IdPersona INNER JOIN
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'Right = 320
            End
            DisplayFlags = 280
            TopColumn = 0
         End
