...
SELECT dbo.cp_orden_pago.IdEmpresa, dbo.cp_orden_pago.IdOrdenPago, dbo.ct_cbtecble_det.IdTipoCbte, dbo.ct_cbtecble_det.IdCbteCble, dbo.ct_cbtecble_det.secuencia, dbo.cp_orden_pago.Fecha, dbo.cp_orden_pago.Observacion, 
                  ...
                  dbo.tb_sucursal.Su_Descripcion, CASE WHEN cp_orden_pago.IdTipo_op = 'FACT_PROVEE' THEN ISNULL(cp_proveedor_detalle.num_cta_acreditacion, cp_proveedor.num_cta_acreditacion) 
                  WHEN cp_orden_pago.IdTipo_op <> 'FACT_PROVEE' AND cp_orden_pago.IdTipo_Persona = 'PROVEE' THEN isnull(opcuenta.num_cta_acreditacion, opprov.num_cta_acreditacion) END AS num_cta_acreditacion, 
                  dbo.cp_orden_pago.IdTipo_Persona
FROM     dbo.ct_cbtecble INNER JOIN
                  ...
                  dbo.cp_proveedor_detalle AS opcuenta ON dbo.cp_orden_pago.SecuenciaProveedor = opcuenta.Secuencia AND dbo.cp_orden_pago.IdEmpresa = opcuenta.IdEmpresa AND 
                  dbo.cp_orden_pago.IdEntidad = opcuenta.IdProveedor LEFT OUTER JOIN
