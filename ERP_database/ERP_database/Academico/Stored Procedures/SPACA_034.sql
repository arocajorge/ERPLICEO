...
LEFT OUTER JOIN aca_AnioLectivoConductaEquivalencia equiv with (nolock) on equiv.IdEmpresa=mco.IdEmpresa and equiv.IdAnio=m.IdAnio and equiv.Secuencia = mco.SecuenciaPromedioFinal
LEFT OUTER JOIN
